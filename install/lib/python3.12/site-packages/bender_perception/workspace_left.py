...
class WorkspaceGridSampler(Node):
    def __init__(self):
        super().__init__("workspace_grid_sampler_left")

        # Parámetros
        self.group_name = "left_arm"
        self.link_name = "l6l_1"  # efector final
        ...
        self.marker_pub = self.create_publisher(Marker, '/workspace_left_points', 10)
        ...
        self.save_csv("workspace_left_grid.csv")
